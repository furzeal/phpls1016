...
if (defined("G")) {
    ...
    echo "G = " . G;
    echo "<br/>";
    // Шаталов: Добавил попытку изменить значение константы
    define("G", 15);
    echo "Пытаемся изменить значение константы G<br/>";
    echo "G = " . G;
}
echo "<br/><br/>";
...
// Task #7
// Принято.
// Исправить использование переменной.
// Если необходимо объявить, это делается так:
// $result = 0;
// Или
// $result = '';
// Любое написание имени переменной является ее использованием.
// Люоое использование без предварительного присвоения значения генерирует предупреждение интерпретатора
echo '<h3>Задание #7</h3>';
// Шаталов: объявил переменную
$result = 0;
for ($x = 1; $x <= 10; $x++) {
    for ($y = 1; $y <= 10; $y++) {
        $result = $x * $y;
